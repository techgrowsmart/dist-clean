...
const TOP_SUBJECTS = [
  { id: '1', name: 'Mathematics', image: 'https://images.unsplash.com/photo-1509228468518-180dd4864904?w=400&q=80' },
  { id: '2', name: 'Science', image: 'https://images.unsplash.com/photo-1532094349884-543bc11b234d?w=400&q=80' },
  { id: '3', name: 'Geography', image: 'https://images.unsplash.com/photo-1524661135-423995f22d0b?w=400&q=80' },
  { id: '4', name: 'History', image: 'https://images.unsplash.com/photo-1461360370896-922624d12aa1?w=400&q=80' },
  { id: '5', name: 'English', image: 'https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?w=400&q=80' },
  { id: '6', name: 'Language', image: 'https://images.unsplash.com/photo-1517842645767-db50dd7f8ad8?w=400&q=80' },
];

const BOTTOM_SUBJECTS = [
  { id: '7', name: 'Computer', image: 'https://images.unsplash.com/photo-1517694712202-14dd9538aa97?w=400&q=80' },
];
...
const SubjectCard = ({ item }: { item: { id: string, name: string, image: string } }) => (
...
export default function Class8SubjectsScreen() {
            ...
            >
              <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.centerContentScroll}>
                ...
                <View style={styles.pageNavHeader}>
                  ...
                  <Text style={styles.pageTitle}>Class 8 | jlbf Subjects</Text>
                </View>
