...
const getProfileImageSource = (profilePic?: string) => {
    ...
    if (typeof profilePic === 'string') {
      ...
      console.log('🖼️ Student profile image URL:', fullUrl);
      return { uri: fullUrl };
    }
        ...
        >
          {refreshing && posts.length === 0 ? (
            ...
            posts.map((post) => {
              ...
              console.log('🔍 Enhanced student post author data:', {
              ...
              return (
                <View key={post.id} style={styles.postCard}>
                  <View style={styles.postHeader}>
                    {getProfileImageSource(displayProfilePic || undefined) ? (
                      <Image 
                        source={getProfileImageSource(displayProfilePic || undefined)!}
                        style={styles.avatar}
                      />
                    ) : (
                      <View style={[styles.avatar, styles.avatarPlaceholder]}>
                        <Text style={styles.avatarText}>
                          {displayName.split(' ').map(word => word.charAt(0)).join('').toUpperCase().slice(0, 2) || 'T'}
                        </Text>
                      </View>
                    )}
                  ...
                  <View style={styles.postActions}>
                    ...
                    >
                      <Ionicons name="flag-outline" size={wp('4.5%')} color="#666666" />
            ...
            <View style={{
              ...
              {currentUser?.profileImage ? (
                ...
                <View style={{
                  ...
                  <Text style={{ fontSize: wp('3.5%'), fontWeight: 'bold', color: '#6B7280' }}>
            ...
            <ScrollView style={{ maxHeight: hp('40%') }}>
              {postComments.length === 0 ? (
                ...
                postComments.map((comment) => {
                  ...
                  console.log('💬 Enhanced student comment author data:', {
                    ...
                    <View key={comment.id} style={{
                      ...
                      {getProfileImageSource(displayProfilePic || undefined) ? (
                        ...
                        <View style={{
                          ...
                          <Text style={{ fontSize: wp('3%'), fontWeight: 'bold', color: '#6B7280' }}>
                            {displayName.split(' ').map(word => word.charAt(0)).join('').toUpperCase().slice(0, 2) || 'U'}
                          </Text>
                        </View>
                      )}
