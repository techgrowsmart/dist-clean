...
const SKILLS_DATA = [
  { id: '1', name: 'Dance', image: 'https://images.unsplash.com/photo-1546427660-eb346c344ba5?q=80&w=400&fit=crop' },
  { id: '2', name: 'Guitar', image: 'https://images.unsplash.com/photo-1549834125-82d3c48159a3?q=80&w=400&fit=crop' },
  { id: '3', name: 'Photography', image: 'https://images.unsplash.com/photo-1516802273409-68526ee1bdd6?q=80&w=400&fit=crop' },
  { id: '4', name: 'Cooking', image: 'https://images.unsplash.com/photo-1507048331197-7d4ac70811cf?w=400&q=80' },
  { id: '5', name: 'Singing', image: 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=400&q=80' },
  { id: '6', name: 'Coding', image: 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?q=80&w=400&fit=crop' },
  { id: '7', name: 'Handcraft', image: 'https://images.unsplash.com/photo-1452860606245-08befc0ff44b?q=80&w=400&fit=crop' },
  { id: '8', name: 'Painting', image: 'https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8b?q=80&w=400&fit=crop' },
  { id: '9', name: 'Yoga', image: 'https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?q=80&w=400&fit=crop' },
  { id: '10', name: 'Video Editing', image: 'https://images.unsplash.com/photo-1535016120720-40c746a65518?w=400&q=80' },
  { id: '11', name: 'Content Writing', image: 'https://images.unsplash.com/photo-1517842645767-db50dd7f8ad8?w=400&q=80' },
  { id: '12', name: 'CAD/CAM', image: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?q=80&w=400&fit=crop' },
];
...
const Banner = () => (
  <View style={styles.bannerContainer}>
    <Image source={{ uri: 'https://images.unsplash.com/photo-1542435503-956c469947f6?q=80&w=1200&fit=crop' }} style={styles.bannerImage} />
    <View style={styles.bannerOverlay}>
      <Text style={styles.bannerSmallText}>Upgrade your Skills</Text>
      <Text style={styles.bannerLargeText}>Conquer the world</Text>
    </View>
  </View>
);

const SkillCard = ({ item }: { item: typeof SKILLS_DATA[0] }) => (
  <View style={styles.skillCardWrapper}>
    <ImageBackground 
      source={{ uri: item.image }} 
      style={styles.skillCardImageBg} 
      imageStyle={{ borderRadius: 14 }}
      resizeMode="cover"
    >
      <View style={styles.skillCardGradientOverlay}>
        <Text style={styles.skillCardCenterText}>{item.name}</Text>
      </View>
    </ImageBackground>
  </View>
);
            ...
            >
              <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.centerContentScroll}>
                ...
                <View style={styles.pageNavHeader}>
                  ...
                  <Text style={styles.pageTitle}>All Skills</Text>
                </View>
...
const styles = StyleSheet.create({
  ...
  skillCardWrapper: {
    width: '31.5%',  // Forms a 3-column grid
    height: 120, // Equal height fixed
    marginBottom: 16, // precise visual spec
    borderRadius: 14,
  ...
  skillCardGradientOverlay: {
    ...StyleSheet.absoluteFillObject,
    backgroundColor: 'rgba(0,0,0,0.45)', // approximate the requested overlay effect globally
    borderRadius: 14,
