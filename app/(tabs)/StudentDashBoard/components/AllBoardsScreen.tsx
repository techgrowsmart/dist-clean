...
const BOARDS_DATA = [
  { id: '1', name: 'CBSE', logo: 'https://ui-avatars.com/api/?name=CBSE&background=F5F7FB&color=3B5BFE&rounded=true&size=150' },
  { id: '2', name: 'ICSE', logo: 'https://ui-avatars.com/api/?name=ICSE&background=F5F7FB&color=3B5BFE&rounded=true&size=150' },
  { id: '3', name: 'WBBSE', logo: 'https://ui-avatars.com/api/?name=WBBSE&background=F5F7FB&color=3B5BFE&rounded=true&size=150' },
  { id: '4', name: 'NIOS', logo: 'https://ui-avatars.com/api/?name=NIOS&background=F5F7FB&color=3B5BFE&rounded=true&size=150' },
  { id: '5', name: 'WBCHSE', logo: 'https://ui-avatars.com/api/?name=WBCHSE&background=F5F7FB&color=3B5BFE&rounded=true&size=150' },
  { id: '6', name: 'KVS', logo: 'https://ui-avatars.com/api/?name=KVS&background=F5F7FB&color=3B5BFE&rounded=true&size=150' },
  { id: '7', name: 'NVS', logo: 'https://ui-avatars.com/api/?name=NVS&background=F5F7FB&color=3B5BFE&rounded=true&size=150' },
  { id: '8', name: 'MSBSHSE', logo: 'https://ui-avatars.com/api/?name=MS&background=F5F7FB&color=3B5BFE&rounded=true&size=150' },
  { id: '9', name: 'TNSB', logo: 'https://ui-avatars.com/api/?name=TNSB&background=F5F7FB&color=3B5BFE&rounded=true&size=150' },
  { id: '10', name: 'UPMSP', logo: 'https://ui-avatars.com/api/?name=UPMSP&background=F5F7FB&color=3B5BFE&rounded=true&size=150' },
  { id: '11', name: 'RBSE', logo: 'https://ui-avatars.com/api/?name=RBSE&background=F5F7FB&color=3B5BFE&rounded=true&size=150' },
  { id: '12', name: 'PSEB', logo: 'https://ui-avatars.com/api/?name=PSEB&background=F5F7FB&color=3B5BFE&rounded=true&size=150' },
];
...
const BoardCard = ({ item }: { item: typeof BOARDS_DATA[0] }) => (
  <View style={styles.boardCardWrapper}>
    ...
    <View style={styles.boardLabelPill}>
      <Text style={styles.boardLabelText}>{item.name}</Text>
    </View>
  </View>
);
