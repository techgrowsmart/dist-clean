    ...
    try {
      ...
      if (auth?.token === "google_play_test_token_2024" && auth?.email === "student1@example.com") {
        ...
        const mockBoards: BoardData[] = [
          { board: "CBSE", boardname: "Central Board of Secondary Education", name: "CBSE", fullName: "Central Board of Secondary Education", id: '1', teacherCount: 1250, description: "India's largest education board", headquarters: "New Delhi", established: "1962", color: '#FF6B6B' },
          { board: "ICSE", boardname: "Indian Certificate of Secondary Education", name: "ICSE", fullName: "Indian Certificate of Secondary Education", id: '2', teacherCount: 890, description: "Comprehensive education system", headquarters: "New Delhi", established: "1958", color: '#4ECDC4' },
          { board: "State Board", boardname: "State Board of Education", name: "State Board", fullName: "State Board of Education", id: '3', teacherCount: 2100, description: "State-specific education boards", headquarters: "Multiple States", established: "Various", color: '#45B7D1' },
          { board: "IB", boardname: "International Baccalaureate", name: "IB", fullName: "International Baccalaureate", id: '4', teacherCount: 450, description: "International education framework", headquarters: "Geneva, Switzerland", established: "1968", color: '#96CEB4' }
        ];
